...
url: 'https\://bookdown.org/jefflinmd38/R_BioST_book/'
documentclass: book
bibliography: [book.bib, packages.bib]
biblio-style: apalike
link-citations: yes
github-repo: "jefflinmd/R_BioST_book"
cover-image: "images/Andrea_HS.png"
...
library(knitr)
opts_chunk$set(tidy.opts=list(width.cutoff=80, tidy=TRUE, highlight=FALSE, collapse=TRUE), fig.width = 4.5, fig.height = 3.5)
# show text in hook1
